...
{
	partial class FormCompraVitaminas
	{
		...
		private void InitializeComponent()
		{
			...
			groupBoxCompraVitaminas.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)dgvCompras).BeginInit();
			SuspendLayout();
			// 
			// groupBoxCompraVitaminas
			// 
			groupBoxCompraVitaminas.BackColor = Color.FromArgb(185, 178, 154);
			groupBoxCompraVitaminas.Controls.Add(lblSumaTotal);
			groupBoxCompraVitaminas.Controls.Add(btnCalcularSumaTotal);
			groupBoxCompraVitaminas.Controls.Add(txtSumaTotal);
			groupBoxCompraVitaminas.Controls.Add(listBoxVitaminas);
			groupBoxCompraVitaminas.Controls.Add(txtCantidad);
			groupBoxCompraVitaminas.Controls.Add(lblCantidad);
			groupBoxCompraVitaminas.Controls.Add(btnEliminarDatos);
			groupBoxCompraVitaminas.Controls.Add(txtPrecioUnidad);
			groupBoxCompraVitaminas.Controls.Add(lblPrecioUnidad);
			groupBoxCompraVitaminas.Controls.Add(txtTotal);
			groupBoxCompraVitaminas.Controls.Add(lblTotal);
			groupBoxCompraVitaminas.Controls.Add(btnCalcularTotal);
			groupBoxCompraVitaminas.Controls.Add(btnConfirmarCompra);
			groupBoxCompraVitaminas.Location = new Point(32, 39);
			groupBoxCompraVitaminas.Margin = new Padding(3, 4, 3, 4);
			groupBoxCompraVitaminas.Name = "groupBoxCompraVitaminas";
			groupBoxCompraVitaminas.Padding = new Padding(3, 4, 3, 4);
			groupBoxCompraVitaminas.Size = new Size(681, 674);
			groupBoxCompraVitaminas.TabIndex = 0;
			groupBoxCompraVitaminas.TabStop = false;
			groupBoxCompraVitaminas.Text = "Compra de Vitaminas";
			// 
			// lblSumaTotal
			// 
			...
			// listBoxVitaminas
			// 
			listBoxVitaminas.FormattingEnabled = true;
			listBoxVitaminas.Items.AddRange(new object[] { "Desparasitante", "Antibiotico", "Vitamina", "Insecticida" });
			listBoxVitaminas.Location = new Point(69, 28);
			listBoxVitaminas.Margin = new Padding(3, 4, 3, 4);
			listBoxVitaminas.Name = "listBoxVitaminas";
			listBoxVitaminas.Size = new Size(251, 84);
			listBoxVitaminas.TabIndex = 0;
			// 
			// txtCantidad
			// 
			...
			Controls.Add(groupBoxCompraVitaminas);
			Margin = new Padding(3, 4, 3, 4);
			Name = "FormCompraVitaminas";
			Text = "Compra de Vitaminas";
			groupBoxCompraVitaminas.ResumeLayout(false);
			groupBoxCompraVitaminas.PerformLayout();
			((System.ComponentModel.ISupportInitialize)dgvCompras).EndInit();
			ResumeLayout(false);
		}

		private System.Windows.Forms.GroupBox groupBoxCompraVitaminas;
		private System.Windows.Forms.ListBox listBoxVitaminas;
